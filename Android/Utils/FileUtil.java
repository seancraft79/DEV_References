...
public class FileUtil {
    ...
    public static boolean writeAssetFileToStorage(Context context, String folderPath, final String fileName) {
        try {
            ...
            if(!isFile) {
                Log.e("FileUtil", "[writeAssetFileToStorage] no asset file found name : " + fileName);
                return false;
            }
            ...
            Log.e("FileUtil", "[writeAssetFileToStorage] error : " + e.getMessage());
        }
        return false;
    }
}

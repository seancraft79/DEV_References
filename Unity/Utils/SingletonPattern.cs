...
public class SingletonPattern<T> : MonoBehaviour where T : MonoBehaviour
{
    ...
    public static T Instance
    {
        get
        {
            ...
            {
                Debug.LogError($"{LOGTAG} {_singletonType} instance is already destroyed.");
                return null;
            }
    ...
    protected virtual void OnDestroy()
    {
        ...
        if (instance == this && !m_isForcefullyDestroyed)
        {
            ...
            Debug.LogError($"{LOGTAG} OnDestory {this.GetType().Name}");
        }
    }
    ...
    protected virtual void Init()
    {
        ...
        {
            Debug.LogError($"{LOGTAG} init destory : {CachedGameObject.name}");
